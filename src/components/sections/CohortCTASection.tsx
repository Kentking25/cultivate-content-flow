...
const CohortCTASection = () => {
  ...
  const perfect = [
    "You're a coach or selling courses/info products",
    "Your business is your main focus, but you're also probably managing a family",
    "You're posting but getting crickets – low engagement, slow growth",
    "You've tried free advice and generic templates but nothing felt authentic",
    "You know your business would grow if you had more eyeballs and attention",
    "You're drowning in 'what should I create' and need clarity",
    "You consume content in the evenings when you finally have a minute to breathe",
    "You want a systematic approach, not another motivational pep talk"
  ];

  const canPromise = [
    "A clear, personalized content strategy",
    "Weekly group coaching with real feedback",
    "Templates and frameworks customized for your business",
    "A supportive group of people in similar situations",
    "Lifetime access to everything we create together"
  ];

  const cantPromise = [
    "You'll go viral overnight",
    "You'll gain 10K followers in a week",
    "It'll work if you don't implement",
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            ...
            <p className="text-gray-400">
              Next cohort starts February 3rd • Only 4 spots • Investment increases after 3rd cohort
            </p>
          </div>
        </motion.div>
