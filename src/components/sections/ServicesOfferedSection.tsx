...
const ServiceCard = ({
  ...
  return <motion.div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 h-full flex flex-col" initial={{
    opacity: 0,
    y: 30
  }} animate={{
    opacity: 1,
    ...
    delay
      ...
      <div className="text-center mt-auto">
        <a href={linkTo} className="btn-primary text-lg px-6 py-3 inline-block mb-3 w-full">
          {buttonText} →
        </a>
